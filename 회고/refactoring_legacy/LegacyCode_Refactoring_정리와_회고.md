...
영향을 차단하여 단순화하자. 객체간의 영향을 차단하여 단순화하는 것을 캡슐화라고 한다. 캡슐화는 영향 받는 경로를 정의하고, 이외의 영향은 차단하게 된다. 즉, 객체지향의 **캡슐화**가 **영향을 단순화하고 추론을 도와준다**는 것을 알 수 있다. (cf. 애그리거트)

...
1. 요즘 postgres가 핫한데,, 왜 핫할까 궁금해졌다.
...
2. 장점
    ...
    5. 100% 오픈소스
3. 단점
    - lack of a native scale-out story like native sharding 기본 샤딩 같은 기본 확장 스토리가 부족
    - connection model is also really limiting. 연결 모델도 정말 제한적
    - overreliance on external tooling. 기본 작업을 적절하게 수행하기 위해 외부 도구에 지나치게 의존
4. 기능
    - 특정 시점 복구
        - PITR
...
![NoIndexTable](postgre_no_index_table.jpg)
